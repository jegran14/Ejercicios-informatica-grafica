...
function initShaders() {
  ...
  gl.uniform3f(program.Color1Index, 1.0, 0.0, 0.0);
  gl.uniform3f(program.Color2Index, 1.0, 1.0, 0.0);
}
...
function setShaderLight() {
  ...
  gl.uniform3f(program.PositionIndex, 0.0,0.0,0.0); // en coordenadas del ojo
...
function initHandlers() {
  ...
  data[0].addEventListener("change",
                             function(){
                             setColor(program.Color1Index, data[0].value);
                             requestAnimationFrame(drawScene);
                             },
                             false);
  
  data[1].addEventListener("change",
                             function(){
                             setColor(program.Color2Index, data[1].value);
                             requestAnimationFrame(drawScene);
                             },
                             false);
  ...
  data[2].addEventListener("mousemove",
                           function(){
                           gl.uniform1f(program.ScaleIndex, data[2].value/10.0);
                           requestAnimationFrame(drawScene);
                           },
                           false);
}
