...
function initShaders() { 
  ...
  gl.uniform1f(program.StripeWidthIndex, 0.5);
  gl.uniform1f(program.StripeScaleIndex, 20.0);
  gl.uniform3f(program.StripeColorIndex, 1.0, 0.25, 0.25);
}
...
function initHandlers() {
  ...
  data[1].addEventListener("change",
                           function(){
                             setColor(program.StripeColorIndex, data[1].value);
                             requestAnimationFrame(drawScene);
                           },
                           false);
  ...
  data[2].addEventListener("mousemove",
                           function(){
                             gl.uniform1f(program.StripeWidthIndex, data[2].value/100.0);
                             requestAnimationFrame(drawScene);
                           },
                           false);
  ...
  data[3].addEventListener("mousemove",
                           function(){
                             gl.uniform1f(program.StripeScaleIndex, data[3].value);
                             requestAnimationFrame(drawScene);
                           },
                           false);
}
