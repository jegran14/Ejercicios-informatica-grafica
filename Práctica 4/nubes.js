...
function initShaders() {
  ...
  gl.uniform1f(program.ScaleIndex, 2.0);
  gl.uniform3f(program.SkyColorIndex, 0.0, 0.0, 1.0);
...
function initHandlers() {
  ...
  data[0].addEventListener("change",
                             function(){
                             setColor(program.SkyColorIndex, data[0].value);
                             requestAnimationFrame(drawScene);
                             },
                             false);
  ...
  data[1].addEventListener("change",
                             function(){
                             setColor(program.CloudColorIndex, data[1].value);
                             requestAnimationFrame(drawScene);
                             },
                             false);
  ...
  data[2].addEventListener("mousemove",
                           function(){
                           gl.uniform1f(program.ScaleIndex, data[2].value/5.0);
                           requestAnimationFrame(drawScene);
                           },
                           false);
}
